      ...
      <NSCard className='mt-4'>
        <div className="flex justify-between">
          ...
          <div className="flex items-center gap-2">
            <NSSearchbar placeholder='Search...' className='w-20' showSearchIcon={false} style={{height: '30px'}} />
            <NSDropdown options={[]} className='w-28' />
            <NSDropdown options={[]} className='w-28' />
            <NSButton title='Replace' style={{height: '30px', paddingTop: '4px'}} />
          </div>
        </div>
      </NSCard>
    </NSLayout>
